...
* First, open and save all video pages by using the Macro Scheduler script
* Run the java program to extract individual video links and save them to a text file.
